"""
Configuration for the TripPilot AI Multi-Agent System.

Runtime secrets are read from environment variables or a local .env file.
"""
import os
...
LLM_CONFIG = {
    ...
    "model_name": os.getenv("TRIPPILOT_LLM_MODEL", "Pro/deepseek-ai/DeepSeek-R1"),
    "base_url": os.getenv("TRIPPILOT_LLM_BASE_URL", "https://api.siliconflow.cn/v1"),
    "temperature": float(os.getenv("TRIPPILOT_LLM_TEMPERATURE", "0.7")),
    "max_tokens": int(os.getenv("TRIPPILOT_LLM_MAX_TOKENS", "8192")),
}
